  ...
  <nav
    ...
    <div class="nav-wrapper orange">
      <div class="header-search-wrapper hide-on-med-and-down">
        ...
        <a href="#!" class="brand-logo display-flex ml-2">
          <img src="{{ asset("images/logo/LogoDemons.png") }}" height="47" width="77" alt="Logo" />
          <h6  class="font-40s"style="color: white">Colégio de Demonstração</h6>
        </a>
        <!--i class="material-icons   logo-somi">search</i>
        <input class="header-search-input z-depth-2" type="text" name="Search" placeholder="Explore SikolaSoft"
          data-search="template-list">
        <ul class="search-list collection display-none"></ul-->
      </div>
      <!-- para alteração de língua-->
      <ul class="navbar-list right">
        ...
        <li>
          <a class="waves-effect waves-block waves-light notification-button" href="javascript:void(0);"
            ...
            <time class="media-meta grey-text darken-2" datetime="2021-04-05T20:50:48+08:00"></time>
      ...
      <ul class="dropdown-content" id="notifications-dropdown">
        <li>
          <h6>Notificação<span class="new badge">5</span></h6>
        </li>
        <li class="divider"></li>
        <li>
      ...
      <div class="nav-wrapper">
        <form id="navbarForm">
          <div class="input-field search-input-sm">
            <input class="search-box-sm mb-0" type="search" required="" placeholder='Explore SikolaSoft' id="search"
              data-search="template-list">
