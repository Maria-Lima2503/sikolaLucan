<div class="navbar @if(($configData['isNavbarFixed'])=== true){{'navbar-fixed'}} @endif">
  <nav
    ...
    <div class="nav-wrapper gradient-45deg-amber-amber">
      <ul class="left">
        <li>
          <h1 class="logo-wrapper">
            <a class="brand-logo darken-1" href="{{asset('/')}}">
              <img src="{{asset($configData['smallScreenLogo'])}}" alt="SikolaSoft logo">
      ...
      <div class="nav-wrapper ">
        <form id="navbarForm">
          <div class="input-field search-input-sm">
            <input class="search-box-sm" type="search" required="" placeholder='Explore  SikolaSoft' id="search"
              data-search="template-list">
