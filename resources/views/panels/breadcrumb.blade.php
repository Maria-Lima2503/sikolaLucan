@if($configData['mainLayoutType'] === 'vertical-dark-menu')
{{-- vertical-dark-menu breadcrumb --}}
<div class="breadcrumbs-dark pb-0 pt-4 gradient-45deg-amber-amber " id="breadcrumbs-wrapper">
  ...
  <div class="container">
    <div class="row ">
      ...
      <div class="col s12 m6 l6 right ">
       <p> <h5 class="breadcrumbs-title mt-0 mb-0 right"><span>@yield('title') </span></h5><br>
        @if(isset($breadcrumbs))
        <ol class="breadcrumbs right  mb-0 mr-0 ">
