...
<head>
  ...
  <title>@yield('title') | SikolaSoft - Sistema de Gestão Escolar</title>
  <link rel="apple-touch-icon" href="{{asset('images/favicon/logoSikola.png')}}">
  <link rel="shortcut icon" type="image/x-icon" href="{{asset('images/favicon/logoSikola.png')}}">
