...
@section("title","Documentos Úteis")
            ...
            <form action="">
               <div class="row col s12">
                  <div class="input-field col m6 s12 Centralizar " >
                        ...
                        <label >Tipo de Existência</label>
                    </div>
                    <div class="input-field col m6 s12 Centralizar " >
                        <select class="validate">
                            <option value=" " disabled selected></option>
                            <option value="1">Razoável</option>
                            <option value="2">Efetiva</option>
                        </select>
                        <label >Obrigatóriedade</label>
                    </div>
            ...
            <section class="users-list-wrapper section">
                    ...
                    <div class="card green darken-1">
                        <div class="card-content">
                            <p class="caption mb-0" style="color: white"><i class="material-icons  left">description</i>
                                <span>Manuteção Documentos Úteis</span>
                            </p>
                        </div>
                    </div>
