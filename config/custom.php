...
return [
    'custom' => [
        ...
        'largeScreenLogo' => 'images/logo/logoSikola.png', //we used saparete log image for large screen and small
        'smallScreenLogo' => 'images/logo/logoSikola.png', // pass the image path here e.g:'images/logo/materialize-logo-color.png' note:(Vertical-menu-nav-dark and horizontal-menu template used a single logo in both small and large screen)
